...
export default {
  ...
  methods: {
    fetchData() {
      getPayChannelName(this.listQuery).then(response => {
        this.tableData = response.data.results
        this.tabletotal = response.data.count
      })
    },
    addGroupSubmit(formdata) {
      postPayChannelName(formdata).then(response => {
        this.$message({
          message: '恭喜你，添加成功',
          type: 'success'
        })
    ...
    editGroupSubmit(formdata) {
      putPayChannelName(this.rowdata.id, formdata).then(response => {
        this.$message({
          message: '恭喜你，更新成功',
          type: 'success'
        })
    ...
    deleteGroup(id) {
      deletePayChannelName(id).then(response => {
        this.$message({
          message: '恭喜你，删除成功',
          type: 'success'
        })
