...
/* harmony default export */ var test = ({
  ...
  methods: {
    sendMail: function sendMail() {
      this.ws.send(stringify_default()(this.mailForm));
    },
    wsInit: function wsInit() {
      var _this = this;

      var self = this;
      self.ws = new WebSocket(config["ws_url"] + self.ws_stream);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-4179d980","hasScoped":false,"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/tools/test.vue
var test_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('el-card',{staticStyle:{"width":"500px","margin":"20px","padding":"20px"}},[_vm._v("\n  收件人: "),_c('el-input',{attrs:{"placeholder":"请输入收件人"},model:{value:(_vm.mailForm.to_list),callback:function ($$v) {_vm.$set(_vm.mailForm, "to_list", $$v)},expression:"mailForm.to_list"}}),_vm._v("\n  抄送者: "),_c('el-input',{attrs:{"placeholder":"请输入抄送者","disabled":""},model:{value:(_vm.mailForm.cc_list),callback:function ($$v) {_vm.$set(_vm.mailForm, "cc_list", $$v)},expression:"mailForm.cc_list"}}),_vm._v("\n  主 题: "),_c('el-input',{attrs:{"placeholder":"请输入主题","disabled":""},model:{value:(_vm.mailForm.sub),callback:function ($$v) {_vm.$set(_vm.mailForm, "sub", $$v)},expression:"mailForm.sub"}}),_vm._v("\n  邮件内容: "),_c('el-input',{attrs:{"placeholder":"请输入邮件内容","disabled":""},model:{value:(_vm.mailForm.context),callback:function ($$v) {_vm.$set(_vm.mailForm, "context", $$v)},expression:"mailForm.context"}}),_vm._v(" "),_c('el-button',{attrs:{"type":"success","plain":""},on:{"click":_vm.sendMail}},[_vm._v("发送测试邮件")])],1)}
