  ...
  methods: {
    ...
    fetchSecondData: function fetchSecondData() {
      ...
      Object(menu["c" /* getSecondmenus */])().then(function (response) {
        _this2.secondData = response.data;
      });
    },
    fetchRouterData: function fetchRouterData(group) {
      ...
      Object(perm["a" /* getMenuPerm */])(parmas).then(function (response) {
        _this3.routerData = response.data;
      });
    },
    ...
    handleCheckChange: function handleCheckChange(data, checked) {
      ...
      this.menuform.secondmenus = [].concat(toConsumableArray_default()(new set_default.a(this.menuform.secondmenus)));
    },
...
// load the styles
var content = __webpack_require__("EByi");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("52d78306", content, true);
